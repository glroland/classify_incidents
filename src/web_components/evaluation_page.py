...
from web_components.evaluation_tab_heat_map_issue import view_evaluation_heat_map_by_issue
from web_components.evaluation_tab_heat_map_server import view_evaluation_heat_map_by_server
