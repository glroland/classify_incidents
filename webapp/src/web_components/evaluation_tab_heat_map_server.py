...
def view_evaluation_heat_map_by_server(space_id, command):
    ...
    if len(df) == 0:
        ...
        st.markdown("I'm sorry but this data set has no data to analyze.  This may be due to the analysis process not running first or an issue with the AI model analyzing the raw data.")
        return
